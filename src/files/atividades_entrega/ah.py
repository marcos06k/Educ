...
def main():
    ...
    genai.configure(api_key="AIzaSyC7gNYqwzuCkNdmnLwoPMIMHqc7aswyhik")
    ...
    if assistente_falante:
        ...
        engine.setProperty('rate', 270) # velocidade 120 = lento
    ...
    while True:
        if ligar_microfone:
            ...
            texto = r"""
The following python code, when imported by another script, returns the error :

Traceback (most recent call last):
  File "C:\Users\rickr\Desktop\Sims 4 Python Script Workspace\decompile_all.py", line 1, in <module>
    from Utilities import extract_folder
  File "C:\Users\rickr\Desktop\Sims 4 Python Script Workspace\Utilities\__init__.py", line 6, in <module>
    from Utilities.unpyc3 import decompile
  File "C:\Users\rickr\Desktop\Sims 4 Python Script Workspace\Utilities\unpyc3.py", line 77, in <module>
