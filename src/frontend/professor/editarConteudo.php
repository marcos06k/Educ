...
<body class="bg-fundo-claro flex font-poppins h-screen ">
    <form action="teste.php" method="post" style="display: none;">
        <input id="inputIdTurma" type="text" name="inputIdTurma">
     ...
     <main class="flex w-full h-full items-center justify-center gap-x-12 gap-y-9 2xl:gap-x-20 mt-6 mb-12 2xl:mt-8">
        ...
        <div class="bg-white shadow-md rounded-xl h-full w-[440px] overflow-hidden relative ml-14">
            <div class="flex justify-center items-center h-1/6 bg-roxo-claro text-center">
                <h1 class="text-white font-semibold text-lg">Editar Conteudo</h1>
            </div>
            <div class="text-roxo-claro flex flex-wrap p-10 justify-center h-[550px] overflow-y-auto gap-5">
                ...
                echo "
                <form action='../../backend/professor/prof_editarConteudo.php' method='post' enctype='multipart/form-data' class='flex flex-col' >
                    <input id='idConteudo' type='text' value=$idConteudo name='idConteudo_conteudo' style='display: none;'>    
                    ...
                    <label class='font-montserrat' for='nome'>NOME DA AULA</label>
                      <input
