    ...
    <section class="flex flex-col w-full h-screen items-center">
     ...
     <main class="flex w-full h-full items-center justify-start gap-x-12 gap-y-9 2xl:gap-x-20 mt-6 mb-12 2xl:mt-8">
        ...
        <div class="bg-white shadow-md rounded-xl h-full w-[440px] overflow-hidden relative ml-14">
            ...
            <form action='aula.php' method='post' class='flex border border-roxo-claro justify-center items-center w-[400px] h-1/4 rounded-2xl hover:bg-violet-50'>
                <input id='idAula' type='text' value='$result_query[0]' name='idAula' style='display: none;'>
                
                <div class=' w-3/4'>
                    <h1 class='font-bold text-2xl'> Aula poo</h1>
                    <div class='text-sm'>
                        <p>Online </p>
                        <p>01/02/12</p>
                    </div>
