...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['arquivo'])) {
        ...
        $idConteudo = $_POST['idConteudo_conteudo'];
        $nome = $_POST['nome'];
        $file = $_FILES['arquivo'];
        ...
        if ($file["error"] === UPLOAD_ERR_OK) {
            ...
            $pastaDir = '../../img/professor/conteudos/';  
            ...
            if (move_uploaded_file($file["tmp_name"], $uploadPath)) {
                ...
                $query_upload_url = mysqli_query($banco, "UPDATE conteudo_assincrono SET arquivo_blob='$arquivo_pasta', nome='$nome';");
                if($query_upload_url){
