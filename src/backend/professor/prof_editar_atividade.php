...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (isset($_FILES['arquivo'])) {
        //Valor do formulario
        $idAtividade = $_POST['idAtividade_atividade'];
        $nome = $_POST['nome'];
        $peso = $_POST['peso'];
        ...
        if ($file["error"] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($file["tmp_name"], $uploadPath)) {
                ...
                $query_upload_url = mysqli_query($banco, "UPDATE atividade SET arquivo_blob='$arquivo_pasta', nome='$nome', peso='$peso', consulta='$consulta', entregavel='$entregavel', prazo_entrega='$prazo_entrega', coletiva='$coletiva' WHERE id_atividade='$idAtividade';");
                if($query_upload_url){
