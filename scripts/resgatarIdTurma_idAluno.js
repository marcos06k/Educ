...
// Pegar o id da turma e o id do aluno quando o Usuário ADM
// clicar no botão Adicioanr
function resgatarIdTurma_idAluno() {
    //Identificar quando clicar no btn adc. aln. e pegar o id da turma
