    ...
    if (isset($_FILES['arquivo'])) {
        ...
        if ($file["error"] === UPLOAD_ERR_OK) {
            ...
            if (move_uploaded_file($file["tmp_name"], $uploadPath)) {
                ...
                $query_upload_url = mysqli_query($banco, "insert into atividade_entrega values (null, '$nomeSobrenome_aluno[0]', '$nomeSobrenome_aluno[1]', now(), '$arquivo_pasta','$nome', null, '$id_aula');");
                if($query_upload_url){
